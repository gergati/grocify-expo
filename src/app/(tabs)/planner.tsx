        ...
        >
            ...
            <View className='gap-4 rounded-3xl border border-border bg-card/70 p-5'>
                <View className='flex-row items-start justify-between'>
                    <View className='flex-1 pr-4'>
                        ...
                        <Text className='mt-2 text-sm leading-5 text-muted-foreground'>Organize your next grocery run with categories, quantities, and priority in one place.
                        </Text>
                    </View>
            ...
            <View className='px-1'>
                ...
                <Text className='mt-1 text-sm text-muted-foreground'>
                    Add items with right quantity, category, and urgency.
                </Text>
            </View>
