...
export default function SignInScreen() {
    ...
    return (
        <SafeAreaView className='flex-1 bg-primary dark:bg-secondary' edges={['top']}>
            {/* decorative elements */}
            <View className='absolute -left-16 top-12 h-56 rounded-full bg-primary/80 dark:bg-background/40' />
            <View className='absolute -right-[-74px] top-40 h-72 rounded-full bg-primary/70 dark:bg-background/35' />
            ...
            <View className='mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6'>
                ...
                <Text className='mt-3 text-center text-sm leading-5 text-muted-foreground'>
                    By continuing, you agree to our Tems and Privacy Policy
                </Text>
